...
router.post(CONSTANTS.ENDPOINT.MASTERDETAIL, (req, res) => {
  console.log(req.body);
  let roleplayer = {
    name: req.body.role,
    id : req.body.id
  };
  sampleData.textAssets[roleplayer.id-1].role = roleplayer.name;
  console.log(sampleData.textAssets[roleplayer.id].role);
  res.json(roleplayer);
});
// LIST ENDPOINTS
